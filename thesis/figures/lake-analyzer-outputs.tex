...
\begin{figure}
  ...
  \end{subfigure}
  \caption[Visualization of outputs created by the \la.]{\label{fig:la:outputs:1}Visualization of outputs created by the \la \emph{(continued on \cpageref{fig:la:outputs:2})}.}
\end{figure}
\begin{figure}
