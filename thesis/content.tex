...
\section{Protocol}
	...
	\section{Messages}
		...
		\subsection{Describe \& Description Message}
			...
			The reply resembles a \emph{DescribeProcess} response and is encoded in a description message referencing the describe message and containing the streaming process description and (see Listing \ref{lst:streaming:message:description}).\pagebreak
	...
	\section{Implementation}
		...
		\begin{figure}
			...
			\end{subfigure}
			\caption{\label{fig:client}Calculation of the seventh Fibonacci number using the Streaming WPS and a simple addition WPS process as delegate \citep{fibonacci}.}
		\end{figure}
