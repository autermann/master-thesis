...
\chapter{Matlab WPS}
	...
	\section{Architecture}
		...
		The WebSocket protocol is accompanied with an HTML5 JavaScript API \citep{w3c:ws}, that is implemented in all recent versions of major desktop browsers\footnote{and with the exception of Opera Mini also mobile browsers} \citep{caniuse}. Besides that, there exist WebSocket client and server implementations for nearly all programming languages (e.g. R\fu{https://github.com/rstudio/R-Websockets}, C\fu{http://libwebsockets.org/trac/libwebsockets}, C\#\fu{http://msdn.microsoft.com/library/system.net.websockets.websocket.aspx}, Java\fu{https://jcp.org/en/jsr/detail?id=356}).
