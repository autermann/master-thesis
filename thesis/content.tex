...
\chapter{Streaming WPS}
	...
	\section{Messages}
		...
		\subsection{Describe \& Description Message}
			...
			The reply resembles a \emph{DescribeProcess} response and is encoded in a description message referencing the describe message and containing the streaming process description and (see \Cref{lst:streaming:message:description}).\pagebreak
