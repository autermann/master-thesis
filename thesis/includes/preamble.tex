...
\usepackage[includefoot,left=4cm,top=3cm,bottom=3cm,right=3cm]{geometry}
...
\usepackage[normal-marks,punct-after]{fnpct}
...
\lstset{%
  ...
  basicstyle=\ttfamily\scriptsize\mdseries\singlespacingnoskip,
...
\newcommand{\texttag}[2]{{\ttfamily\textless\textcolor{keyword}{#1:#2}\textgreater}}
